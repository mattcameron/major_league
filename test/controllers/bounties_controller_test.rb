...
class BountiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bounty" do
    assert_difference('Bounty.count') do
      post bounties_url, params: { bounty: { event_id: @bounty.event_id, name: @bounty.name, user_id: @bounty.user_id, value: @bounty.value } }
    end
  ...
  test "should update bounty" do
    patch bounty_url(@bounty), params: { bounty: { event_id: @bounty.event_id, name: @bounty.name, user_id: @bounty.user_id, value: @bounty.value } }
